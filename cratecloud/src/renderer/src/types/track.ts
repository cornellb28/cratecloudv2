...
export type Track = {
  ...
  // Which board a track belongs to. Every other view already gets this
  // implicitly (it's which columns[boardName] bucket the track sits in) —
  // views that fetch tracks directly from the DB (GenreView, ArtistView)
  // don't have that bucketing and need it as an explicit field instead.
  column_name?: string
}
